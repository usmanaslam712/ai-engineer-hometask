...
**Why OUT_OF_SCOPE is being used:** Both are cases where no human is needed and no PayWallet policy is relevant. Hence no need to add a new lane, OUT_OF_SCOPE works well in this case.
